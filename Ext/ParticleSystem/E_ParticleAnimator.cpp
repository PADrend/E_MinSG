...
EScript::Type* E_ParticleAnimator::typeObject=nullptr;

//! (static)	
void E_ParticleAnimator::init(EScript::Namespace & lib) {
...
E_ParticleAnimator::E_ParticleAnimator(ParticleAnimator * c,EScript::Type * type):E_ParticleAffector(c,type?type:typeObject) {
}

E_ParticleAnimator::~E_ParticleAnimator() {
}
