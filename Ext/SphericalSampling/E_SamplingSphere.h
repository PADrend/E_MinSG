...
#ifndef E_MINSG_SPHERICALSAMPLING_E_SAMPLINGSPHERE_H_
#define E_MINSG_SPHERICALSAMPLING_E_SAMPLINGSPHERE_H_
...
//!	EScript wrapper class for MinSG::SphericalSampling::SamplingSphere
class E_SamplingSphere : public EScript::ExtReferenceObject<MinSG::SphericalSampling::SamplingSphere> {
...
#endif /* E_MINSG_SPHERICALSAMPLING_E_SAMPLINGSPHERE_H_ */
